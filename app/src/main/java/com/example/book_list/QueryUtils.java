...
public class QueryUtils {
    ...
    public static List<Book> fetchBooksData(String reqUrl) throws IOException {
        //create url object
    ...
    private static List<Book> extractFeatureFromJson(String bookJSON) {
        ...
        try {
            ...
            for (int i = 0; i < bookArray.length(); i++) {
                ...
                String imgStr;
                JSONObject imgObj = properties.getJSONObject("imageLinks");
                imgStr = imgObj.getString("smallThumbnail");

                Bitmap fullImg = BitmapFactory.decodeResource(Resources.getSystem(),R.drawable.b1);
                try {
                ...
                books.add(new Book(title,authors,publisher,fullImg));
